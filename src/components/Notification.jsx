...
const Notification = ({ className, title, time,}) => {
  return (
    <div
      className={`${
        className || ""
      } flex items-center p-4 pr-6 bg-[#474060]/40 backdrop-blur border border-white/10 rounded-2xl gap-5`}
    >
      <img src={zari} width={62} height={62} alt="" className="rounded-xl" />
